...
<div id="comments" class="x-comments-area">
  ...
  <?php if ( have_comments() ) : ?>
    ...
    <h2 class="h-comments-title"><span><?php echo number_format_i18n( get_comments_number() ); ?> <?php _e( 'thoughts on' , '__x__' ); ?> <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a> </span></h2>
